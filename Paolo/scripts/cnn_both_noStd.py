...
def preprocess_data(x_train, x_val, x_test, y_train, y_val, y_test, cols):
    ...
    train_std['lat'] = x_train['latitude']/100
    train_std['lon'] = x_train['longitude']/100
    val_std['lat'] = x_val['latitude']/100
    val_std['lon'] = x_val['longitude']/100
    test_std['lat'] = x_test['latitude']/100
    test_std['lon'] = x_test['longitude']/100
...
if __name__ == "__main__":
    ...
    parser.add_argument("--features_list", default=['vo','r','u_200','u_850','v_200','v_850','tcwv','sst','shear','lat','lon'])
