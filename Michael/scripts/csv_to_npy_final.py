...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default='/work/bk1318/b382633/data_csv/predictors_v2_dailymean/')
...
#       'NAO_classic', 'PNA', 'NPD'])
    parser.add_argument("--savepath", default='/work/bk1318/b382633/data_npy/npy_base/')
    parser.add_argument("--area", default='Sindian')
    ...
    np.save(args.savepath+areas[i]+'_y_train_img.npy', y_train_img) 
    np.save(args.savepath+areas[i]+'_y_val_img.npy', y_val_img) 
    np.save(args.savepath+areas[i]+'_y_test_img.npy', y_test_img) 
    np.save(args.savepath+areas[i]+'_train_img_std.npy', train_img_std) 
    np.save(args.savepath+areas[i]+'_val_img_std.npy', val_img_std) 
    np.save(args.savepath+areas[i]+'_test_img_std.npy', test_img_std) 
