...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default='/work/bk1318/b382633/data_npy/npy_base/')
...
#    parser.add_argument("--model", default='CNN')
    ...
    parser.add_argument("--sourcepath_model", default='/work/bk1318/b382633/models/fresh_models/CNN_base_0/')
    parser.add_argument("--savepath_model", default='/work/bk1318/b382633/models/trained_models/CNN_base_0/')
    parser.add_argument("--savepath_prediction", default='/work/bk1318/b382633/predictions/CNN_base_0/')
    parser.add_argument("--x_test_path", default='/work/bk1318/b382633/data_csv/predictors_v2_dailymean/test_dailymeans_Sindian.csv')
